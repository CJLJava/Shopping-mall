...
<body id="home">
	...
	<div class="container">
		...
		<div class="content inside-page payment">
			...
			<h1>评价框</h1>
			<textarea rows="18" cols="60" id="evaluation"></textarea>
			<div class="col-sm-8 col-sm-offset-4">
				<span class="btn btn-primary pull-left" id="submit">evaluation</span>
			</div>
		</div>
	...
	<script type="text/javascript">
		$("#submit")
				.click(
						function() {
										location.href="${pageContext.request.contextPath}/orderForm/evaluation.do?evaluation="+$("#evaluation").val()+ "&clothingId=${requestScope.clothingId}&orderformId=${requestScope.orderformId}";
						});
	</script>
</body>
</html>