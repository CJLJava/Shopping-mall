...
<body id="home">
	...
	<div class="container">
		...
		<div class="content inside-page payment">
			...
			<div class="col-sm-8 col-sm-offset-4">
				<span class="btn btn-primary pull-left" id="confirmationOfReceipt">Confirmation
					Of Receipt</sapn>
			</div>
		</div>
	...
	<script type="text/javascript">
		$("#confirmationOfReceipt")
				.click(
						function() {
							alert("确认收货，已向商家付款，跳到评价页面，订单状态变为4")
							location.href = "${pageContext.request.contextPath}/orderForm/confirmReceipt.do";
						});
	</script>
</body>
</html>