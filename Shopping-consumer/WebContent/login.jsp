			...
			<div class="content inside-page login">
				...
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="checkbox">
							<label> <input type="checkbox" class="btn btn-primary" name="autoLogin"
								value="autoLogin"> Remember password
							</label>
						</div>
				...
				<hr>
				<a href="checkout.jsp" class="btn btn-primary pull-left">Continue
					Shopping</a> <a href="payment.jsp" class="btn btn-primary pull-right">Continue</a>
			</div>
		</form>
	</div>
	<footer>
